...
-- CHECAR FUNCAO MEMBRO PAGAMENTO SE EH FINANCEIRO
CREATE TABLE GASTOS (
...
CREATE TABLE VETERINARIO (
    NOTA_FISCAL VARCHAR2(20),
    CRMV CHAR(10), -- NECESSARIO CHECAR O TAMANHO CORRETO DA STRING
    NOME VARCHAR2(20),
...
CREATE TABLE DOACAO (
    ...
    CONSTRAINT FK_DOACAO_MEMBRO FOREIGN KEY (CPF_MEMBRO, FUNCAO_MEMBRO)
                                REFERENCES MEMBRO(CPF, FUNCAO)
                                ON DELETE CASCADE,
    CONSTRAINT FK_DOCACAO_DOADOR FOREIGN KEY (CPF_DOADOR)
...
CREATE TABLE AVISTAMENTO (
    DATAHORA DATE,
    DESCRICAO_DO_LOCAL VARCHAR2(100),
